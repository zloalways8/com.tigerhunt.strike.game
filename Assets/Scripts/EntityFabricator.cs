...
public class EntityFabricator : MonoBehaviour
{
    // Поля из вашего кода
    ...
    void Start()
    {
        ...
        _currentLevel = PlayerPrefs.GetInt(OmniMetrics.ACTIVE_STAGEID, 1);
    ...
    void CheckForWin()
    {
        ...
        {
            TerminateGameplay(true);

            // Сохранение нового рекорда
            RecordManager.Instance.SaveRecord(_currentLevel, playerScore);
        }
    }
